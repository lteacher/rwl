...
namespace RobotInitial.Command
{
    class CommandBehavior
    {
        ...
        private static readonly DependencyProperty BehaviorProperty =
            DependencyProperty.RegisterAttached("Behavior", typeof(CommandBehaviorBinding),
            typeof(CommandBehavior), new FrameworkPropertyMetadata((CommandBehaviorBinding)null));
        ...
        public static readonly DependencyProperty CommandProperty =
            ...
            typeof(CommandBehavior), new FrameworkPropertyMetadata((ICommand)null,
        ...
        public static readonly DependencyProperty ActionProperty =
            ...
            typeof(CommandBehavior), new FrameworkPropertyMetadata((Action<object>)null,
        ...
        public static readonly DependencyProperty CommandParameterProperty =
            ...
            typeof(CommandBehavior), new FrameworkPropertyMetadata((object)null,
        ...
        {
            CommandBehaviorBinding binding = FetchOrCreateBinding(d);
            binding.CommandParameter = (object)e.NewValue;
        }

        public static readonly DependencyProperty EventProperty =
            DependencyProperty.RegisterAttached("Event", typeof(string),
            typeof(CommandBehavior), new FrameworkPropertyMetadata((string)null,
        ...
        private static void OnEventChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            binding.BindEvent(d, (string)e.NewValue);
        }
